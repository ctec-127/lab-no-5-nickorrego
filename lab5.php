...
<body>
  ...
  <div class="container-fluid mt-3">
    <div class="jumbotron p-3">
      <p class="lead font-weight-bold">Welcome to the Clark College Arboretum! From your desktop or mobile device, you can search through the trees growing on campus.
      ...
      <div class="col-sm-12 col-md-6 col-lg-4">
        <div class="card mt-3 mb-3 shadow">
          <div class="card-header align-leff">
            <a href="https://www.google.com/maps/search/?api=1&query=45.63472,-122.6500">Castor Aralia</a>
          </div>
          <img class="card-img-top" src="img/trees/castor_aralia.jpg" alt="Kalopanax pictus">
          <div class="card-body">
            <p class="card-text"><strong>Common Genus:</strong> Aralia<br><strong>Botanical Name:</strong> <em>Kalopanax pictus</em></p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="col-sm-12 col-md-6 col-lg-4">
        <div class="card mt-3 mb-3 shadow">
          <div class="card-header shadow">
            <a href="https://www.google.com/maps/search/?api=1&query=45.63472,-122.65247">American Arborvitae</a>
          </div>
          <img class="card-img-top" src="img/trees/evergreen48.jpg" alt="occidentalis">
          <div class="card-body">
            <p class="card-text"><strong>Common Genus:</strong> Arborvitae<br> <strong>Botanical Name:</strong> <em>occidentalis</em></p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row mb-3">
      <div class="col-sm-12 col-md-6 col-lg-4">
        <div class="card mt-3 mb-3 shadow">
          ...
          <div class="card-body">
            <p class="card-text"><strong>Common Genus:</strong> Ash<br> <strong>Botanical Name:</strong> <em>americana</em></p>
          </div>
        </div>
      </div>
